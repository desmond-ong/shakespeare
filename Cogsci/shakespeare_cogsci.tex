...
\subsubsection{Stimuli Selection.} We selected a set of 20 actions, comprising a mix of 6 intentional actions, 6 emotional expressions, 5 unintentional behaviors, and 3 ambiguous behaviors. The full set is given in Fig. \ref{Study2ResultsFig}. Of the 6 intentional actions, we chose 3 (``stole a pound of peaches"; ``invited Sue to have lunch"; ``watered his new plants") from \citeA{Malle1999}'s study as they were previously rated as  highly intentional.%, and added three more (``read a book", ``bought a drink", and ``bought a round of drinks for everyone"). 
